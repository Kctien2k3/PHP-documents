<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../paging/public/css/Reset.css">
        <link rel="stylesheet" href="../paging/public/css/style.css">
        <link rel="stylesheet" href="../paging/public/css/users.css">
    </head>
    <body>
        <div id="wrapper">
            <div id="header">
