...
//////////////// hàm liên quan đến login
function check_login($username, $password){
    $check_user = "SELECT * FROM `tbl_users` WHERE `username` = '{$username}' AND `password` = '{$password}'";
    echo $check_user;
    if ($check_user > 0) 
    return true;
    return false;
...
// phần hàm để update email active
